const SHARE_URL = typeof window !== 'undefined' ? window.location.origin : 'https://s-halland.app'
const SHARE_TEXT =
...
export default function ShareButton() {
  ...
  return (
    <button className="btn btn--linkedin" onClick={onShare} aria-label="Share on LinkedIn">
      <svg className="btn__icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
