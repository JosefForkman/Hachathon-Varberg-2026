...
function PanToSelected({ selected }) {
    ...
    useEffect(() => {
        ...
        map.flyTo(
            [selected.centroid.lat, selected.centroid.lon],
        ...
        <div className="map">
                    ...
                    return (
                        <GeoJSON
                            ...
                            eventHandlers={{
                                ...
                                mouseout: (e) =>
                                    e.target.setStyle(styleFor(f.raw, f.id)),
                            }}
                        />
                    );
                })}
            ...
            {loadError && (
                <div className="map__loading">
                    <div>
                        ...
                        Place file at{" "}
                        <code>
                            public/data/halland_skyddade_omraden.geojson
                        </code>
                    </div>
                </div>
            )}
            ...
            <div className="map__legend">
                ...
                <div className="map__legend-row">
                    <span
                        className="map__legend-dot"
                        style={{ color: "#FBBF24", background: "#FBBF24" }}
                    />
                    Medium
                </div>
                <div className="map__legend-row">
                    <span
                        className="map__legend-dot"
                        style={{ color: "#F87171", background: "#F87171" }}
                    />
                    At risk
                </div>
            </div>
