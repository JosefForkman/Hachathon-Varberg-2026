...
export function symbolToLottie(code) {
  ...
  if ([12, 13, 14, 15, 16, 17, 22, 23, 24, 25, 26, 27].includes(code)) return 'snow'
  return 'partly-cloudy'
}

const SYMBOL_LABEL = {
  1: 'Clear sky', 2: 'Nearly clear',
  3: 'Variable clouds', 4: 'Half clear',
  5: 'Cloudy', 6: 'Overcast',
  7: 'Fog',
  ...
  18: 'Light rain', 19: 'Rain', 20: 'Heavy rain',
  21: 'Thunder',
...
export async function fetchHallandForecast({ lat = HALMSTAD.lat, lon = HALMSTAD.lon } = {}) {
  try {
